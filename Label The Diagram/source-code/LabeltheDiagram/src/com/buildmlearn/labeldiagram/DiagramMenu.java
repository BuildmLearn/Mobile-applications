...
public class DiagramMenu extends FragmentActivity {
	...
	public static class DiagramPagerAdapter extends FragmentPagerAdapter {
		...
		/*
		 * @Override public Fragment getItem(int position) { switch (position) {
		 * case 0: return DiagramFragment.getInstance(R.layout.diagram_menu);
		 * case 1: return DiagramFragment.getInstance(R.layout.main_menu); case
		 * 2: return DiagramFragment.getInstance(3); case 3: return
		 * DiagramFragment.getInstance(4); case 4: return
		 * DiagramFragment.getInstance(5);
		 * 
		 * default: return null; } }
		 */
